...
// &r = ALT + R to lock inspector, project etc
// &c = ALT + C to clear console
// &d = ALT + D to debug-normal mode toggle
public class EditorShortcutUtilities
{
    ...
    [MenuItem("Tools/Toggle Inspector Lock (shortcut) &r")]
