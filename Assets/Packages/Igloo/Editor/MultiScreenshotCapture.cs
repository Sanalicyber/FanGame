    ...
    internal static class ReflectionExtensions
    {
        ...
        internal static object CreateInstance(this Type type, params object[] parameters)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < parameters.Length; i++) parameterTypes[i] = parameters[i].GetType();
            }
    ...
    public class MultiScreenshotCapture : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (resolutionsEnabled == null || resolutionsEnabled.Count != resolutions.Count)
            {
                ...
                for (int i = 0; i < resolutions.Count; i++) resolutionsEnabled.Add(true);
            }
            ...
            if (GUILayout.Button("Capture Screenshots"))
            {
                ...
                for (int i = 0; i < resolutions.Count; i++)
                {
                    if (resolutionsEnabled[i]) CaptureScreenshot(resolutions[i]);
                }
        ...
        private void CaptureQueuedScreenshots()
        {
            ...
            else
            {
                ...
                if (queuedScreenshots.Count == 0)
                {
                    ...
                    if (EditorApplication.isPlaying && setTimeScaleToZero) Time.timeScale = prevTimeScale;
        ...
        private void CaptureScreenshotWithoutUI(int width, int height)
        {
            ...
            if (saveAsPNG && allowTransparentBackground) camera.allowHDR = false;
            ...
            finally
            {
                ...
                if (saveAsPNG && allowTransparentBackground) camera.allowHDR = allowHDR;
        ...
        private string PathField(string label, string path)
        {
            ...
            if (GUILayout.Button("o", GL_WIDTH_25))
            {
                ...
                if (!string.IsNullOrEmpty(selectedPath)) path = selectedPath;
